...
const OpeningCardSection: React.FC = () => {
  ...
  const handleStartRound1 = () => {
    ...
    // Use 'start_game' message type (not 'game_start') and send timer as 'timerDuration'
    sendWebSocketMessage({
      ...
      data: {
        ...
        round: 1,
        timer: customTime,
        timerDuration: customTime  // Also send as timerDuration for backend compatibility
      }
    });
