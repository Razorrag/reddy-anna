# Prompt 1: Backend Foundation for Andar Bahar Game

## Objective
Create a complete backend foundation for the Reddy Anna Kossu Andar Bahar game with Express.js, WebSocket integration, and basic database functionality.
...
### 3. src/db.js (In-Memory Database for Development)
```javascript
...
inMemoryDb.game_settings = [
  { id: 1, setting_key: 'max_bet_amount', setting_value: '50000', updated_at: new Date().toISOString() },
  { id: 2, setting_key: 'min_bet_amount', setting_value: '1000', updated_at: new Date().toISOString() },
  { id: 3, setting_key: 'game_timer', setting_value: '30', updated_at: new Date().toISOString() },
  { id: 4, setting_key: 'opening_card', setting_value: 'A♠', updated_at: new Date().toISOString() }
];

inMemoryDb.stream_settings = [
  { id: 1, setting_key: 'stream_url', setting_value: 'hero images/uhd_30fps.mp4', updated_at: new Date().toISOString() },
  { id: 2, setting_key: 'stream_title', setting_value: 'Andar Bahar Live Game', updated_at: new Date().toISOString() },
  { id: 3, setting_key: 'stream_status', setting_value: 'live', updated_at: new Date().toISOString() },
  { id: 4, setting_key: 'stream_type', setting_value: 'video', updated_at: new Date().toISOString() }
];
...
router.post('/update-stream-settings', async (req, res) => {
  try {
    ...
    broadcastStreamStatusUpdate(game_id || 'default-game', {
...
This completes the backend foundation with:
- Express.js server with proper middleware
- In-memory database implementation
- WebSocket server with game state broadcasting
