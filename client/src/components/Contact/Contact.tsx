        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div>
            <div className={cn(getCardClass(), 'mb-6 sm:mb-8')}>
              ...
              <div className="space-y-3 sm:space-y-4 text-gray-300">
                <div className="flex items-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gold rounded-full flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                  ...
                  <div>
                    ...
                    <div className="text-sm sm:text-base">+91 8686886632</div>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm sm:text-base break-all">support@andarbahar.com</div>
                  </div>
                </div>
                
                <div className="flex items-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gold rounded-full flex items-center justify-center mr-3 sm:mr:mr-4 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-black" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <div>
                    ...
                    <div className="text-sm sm:text-base">Hyderabad, Telangana, India</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <a 
              ...
              className={cn(getButtonClass('success'), 'w-full flex items-center justify-center text-base sm:text-lg py-3 sm:py-4')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-2 sm:mr-3" viewBox="0 0 24 24" fill="currentColor">
